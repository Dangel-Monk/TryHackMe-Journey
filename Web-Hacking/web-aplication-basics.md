...
> There are two types of HTTP messages:
	...
	+ HTTP Request: Sent by the user to trigger actions on the web application.
	+ HTTP Response: Sent by the server in response to the user’s request.
